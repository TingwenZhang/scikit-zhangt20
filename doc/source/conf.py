...
# -*- coding: utf-8 -*-
#
# scikit-zhangt20-lvl5 documentation build configuration file, created by
...
modindex_common_prefix = ["scikit-zhangt20-lvl5"]
...
html_context = {
    ...
    "github_repo": "scikit-zhangt20-lvl5",
    "github_version": "main",
...
basename = "scikit-zhangt20-lvl5".replace(" ", "").replace(".", "")
...
latex_documents = [
    (
        "index",
        "scikit-zhangt20-lvl5.tex",
        "scikit-zhangt20-lvl5 Documentation",
        ab_authors,
        "manual",
    ),
]
